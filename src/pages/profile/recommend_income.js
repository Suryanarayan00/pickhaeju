...
const CHECK_LABELS = [
  ...
  {
    key: 2,
    label: '1천만 원 이상 ~ 3천만 원 미만',
  },
  {
    key: 3,
    label: '3천만 원 이상 ~ 5천만 원 미만',
  },
  {
    key: 4,
    label: '5천만 원 이상 ~ 8천만 원 미만',
  },
  {
    key: 5,
    label: '8천만 원 이상',
  ...
  return (
    <>
      <View style={styles.progressBar}>
        <View style={[styles.innerProgressBar, { width: '60%' }]} />
      </View>
      <ScrollView style={styles.container}>
        <Text style={styles.headerText}>현재 연간 소득은 어떻게 되시나요?</Text>
      ...
      <BottomButton
        disabled={!checked}
        onPress={() => {
          navigation.navigate('RecommendWord');
        }}
        fontSize={18}
      >
        다음
...
export default RecommendIncome;
