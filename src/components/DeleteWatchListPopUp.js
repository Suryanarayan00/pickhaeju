...
const DeleteWatchListPopUp = ({ isVisible, onCancel, onDelete }) => {
  return (
    <Modal isVisible={isVisible} onCancel={onCancel}>
      <View style={styles.container}>
        <Text style={styles.titleText}>관심목록을 정말 삭제하시나요?</Text>
        <Text style={styles.contentsText}>
        한 번 삭제된 관심목록은 복구가 불가능합니다.
        </Text>
...
export default DeleteWatchListPopUp;
